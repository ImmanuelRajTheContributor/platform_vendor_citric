...
ALARM_PATH := vendor/citric/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/citric/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/citric/prebuilt/common/media/audio/ringtones
